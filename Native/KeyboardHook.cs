...
namespace UsageWatcher.Native
{
    ...
    internal class KeyboardHook : IDisposable
    {
        ...
        /// low-level hook.
        /// </summary>
        internal event KeyboardHookEventHandler KeyIntercepted;
        ...
        internal KeyboardHook(string param)
            : this()
        {
        ...
        internal KeyboardHook(Parameters param)
            : this()
        {
            SetParameters(param);
        }
        ...
        /// </summary>
        internal class KeyboardHookEventArgs : System.EventArgs
        {
